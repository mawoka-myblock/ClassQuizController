...
class CaptivePortal:
    ...
    def start_access_point(self):
        ...
        self.ap_if.config(ssid=self.essid, password="Passwort", channel=10)
        ...
        print("AP mode configured:", self.ap_if.ifconfig(), self.ap_if.status(), self.ap_if.config("essid"))
