...
bool blue_button_state = HIGH;
bool green_button_state = HIGH;
bool yellow_button_state = HIGH;
bool red_button_state = HIGH;
...
String get_code_as_str(int code_length)
{
    ...
    {
        // blue
        if (digitalRead(Buttons::BLUE) == LOW)
        {
        ...
        if (digitalRead(Buttons::GREEN) == LOW)
        {
        ...
        if (digitalRead(Buttons::YELLOW) == LOW)
        {
        ...
        if (digitalRead(Buttons::RED) == LOW)
        {
